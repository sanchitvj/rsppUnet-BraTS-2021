...
#             in_features=16 * dense_features[0] * dense_features[1] * dense_features[2],
#             out_features=inChans,
#         )
#         self.dense2 = nn.Linear(
#             in_features=midChans,
#             out_features=midChans
#             * dense_features[0]
#             * dense_features[1]
#             * dense_features[2],
#         )
...
#             outChans, outChans, activation=activation, normalizaiton=normalizaiton
#         )
...
#             inChans=inChans, outChans=inChans, dense_features=dense_features
#         )
...
class NvNet(nn.Module):
    def __init__(self, config):
        ...
        self.en_down2 = DownSampling(128, 256)
        self.en_block2_0 = EncoderBlock(
        ...
        self.en_down3 = DownSampling(256, 320)
        ...
        # Decoder Blocks
        self.de_up2 = Deconvolution(320, 256, mode=self.mode)
        self.de_block2 = DecoderBlock(
            256, 256, activation=self.activation, normalizaiton=self.normalizaiton
        )
        self.de_up1 = Deconvolution(256, 128, mode=self.mode)
        self.de_block1 = DecoderBlock(
            128, 128, activation=self.activation, normalizaiton=self.normalizaiton
        )
        self.de_up0 = Deconvolution(128, 64, mode=self.mode)
    ...
    def forward(self, x):
        ...
        out_en3 = self.en_block3_3(
            self.en_block3_2(self.en_block3_1(self.en_block3_0(self.en_down3(out_en2))))
        )
